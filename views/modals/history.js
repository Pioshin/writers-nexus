...
function init() {
  ...
  // Tabs
  tabDetailsBtn = document.getElementById('hist-tab-details');
  tabAiBtn = document.getElementById('hist-tab-ai');
  tabDetailsPane = document.getElementById('hist-tab-details-pane');
  tabAiPane = document.getElementById('hist-tab-ai-pane');
  tabDetailsBtn?.addEventListener('click', () => switchTab('details'));
  tabAiBtn?.addEventListener('click', () => switchTab('ai'));

  // IA controls
  aiInstr = document.getElementById('ai-hist-instructions');
  aiTemp = document.getElementById('ai-hist-temp');
  aiTempVal = document.getElementById('ai-hist-temp-val');
  aiMaxTok = document.getElementById('ai-hist-maxtok');
  aiUseCtx = document.getElementById('ai-hist-use-context');
  aiCtxStatus = document.getElementById('ai-hist-context-status');
  aiGenre = document.getElementById('ai-hist-genre');
  aiTone = document.getElementById('ai-hist-tone');
  aiGenBtn = document.getElementById('ai-hist-generate');
  aiImpBtn = document.getElementById('ai-hist-improve');
  aiStopBtn = document.getElementById('ai-hist-stop');
  aiOut = document.getElementById('ai-hist-output');
  aiApply = document.getElementById('ai-hist-apply');
  aiCopy = document.getElementById('ai-hist-copy');
...
function buildUserPrompt(mode) {
  ...
  const base =
    mode === 'create'
      ? 'Crea un elemento storico o leggenda coerente col mondo.'
  ...
  return [
    ...
    ctx.genre || ctx.tone
      ...
      : null,
    ctx.title || ctx.narration ? `Dati attuali: ${JSON.stringify(ctx)}` : null,
  ]
    .filter(Boolean)
    .join('\n\n');
}
...
function applyAI() {
  ...
  if (obj.narration) narrationInput.value = obj.narration;
}
