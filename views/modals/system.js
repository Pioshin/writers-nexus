...
function init() {
  ...
  // Tabs
  tabDetailsBtn = document.getElementById('sys-tab-details');
  tabAiBtn = document.getElementById('sys-tab-ai');
  tabDetailsPane = document.getElementById('sys-tab-details-pane');
  tabAiPane = document.getElementById('sys-tab-ai-pane');
  tabDetailsBtn?.addEventListener('click', () => switchTab('details'));
  tabAiBtn?.addEventListener('click', () => switchTab('ai'));

  // IA controls
  aiInstr = document.getElementById('ai-sys-instructions');
  aiTemp = document.getElementById('ai-sys-temp');
  aiTempVal = document.getElementById('ai-sys-temp-val');
  aiMaxTok = document.getElementById('ai-sys-maxtok');
  aiUseCtx = document.getElementById('ai-sys-use-context');
  aiCtxStatus = document.getElementById('ai-sys-context-status');
  aiGenre = document.getElementById('ai-sys-genre');
  aiTone = document.getElementById('ai-sys-tone');
  aiGenBtn = document.getElementById('ai-sys-generate');
  aiImpBtn = document.getElementById('ai-sys-improve');
  aiStopBtn = document.getElementById('ai-sys-stop');
  aiOut = document.getElementById('ai-sys-output');
  aiApply = document.getElementById('ai-sys-apply');
  aiCopy = document.getElementById('ai-sys-copy');
...
function buildUserPrompt(mode) {
  ...
  const base =
    mode === 'create'
      ? 'Crea un sistema coerente con regole, costi e limiti.'
      : 'Migliora/Completa questo sistema mantenendo coerenza.';
  return [
    base,
...
function applyAI() {
  ...
  if (obj.rules) rulesInput.value = obj.rules;
