...
function buildUserPrompt(mode){
    ...
    const base = mode === 'create' ? 'Crea un elemento culturale completo (ruoli, valori, rituali, conflitti interni).' : 'Migliora/Completa questo elemento mantenendo coerenza.';
    return [
        base,
